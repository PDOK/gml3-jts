...
public class GML321ToLineConvertor {
  ...
  /**
   * <p>
   * Constructor for GML321ToLineConvertor.
   * </p>
   *
   * @param geometryFactory a {@link org.locationtech.jts.geom.GeometryFactory} object.
   * @param gmlToPointConvertor a
   *        {@link nl.pdok.gml3.impl.gml3_2_1.converters.GML321ToPointConvertor} object.
   */
   ...
   * </p>
   *
   * @param abstractRingPropertyType a {@link net.opengis.gml.v_3_2.AbstractRingPropertyType}
   *        object.
  ...
  public LineString convertMultiCurve(MultiCurveType abstractGeometryType)
      throws GeometryException {
    if (abstractGeometryType instanceof MultiCurveType) {
      List<LineString> segments =
          translateMultiCurveTypeToSegments((MultiCurveType) abstractGeometryType);
      LineString[] array = segments.toArray(new LineString[] {});
      return CompoundLineString.createCompoundLineString(geometryFactory, array);
    } else {
      throw new UnsupportedGeometrySpecificationException(
  ...
  public List<LineString> translateMultiCurveTypeToSegments(MultiCurveType multiCurveType)
      throws GeometryException {
