...
public class ExtendedGeometryFactory extends GeometryFactory {
  ...
  /**
   * <p>
   * Constructor for ExtendedGeometryFactory.
   * </p>
   */
   ...
   * </p>
   *
   * @param coordinateSequenceFactory a {@link org.locationtech.jts.geom.CoordinateSequenceFactory}
   *        object.
   */
  ...
  /**
   * <p>
   * Getter for the field <code>maximumArcApproximationError</code>.
   * </p>
   *
   * @return a double.
   */
  ...
  /**
   * <p>
   * Setter for the field <code>maximumArcApproximationError</code>.
   * </p>
   *
